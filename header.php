    ...
    <head>
		...
		<script type="text/javascript">
			var myform3=new formtowizard({
			 ...
			 revealfx: ['fade', 500] //<--no comma after last setting
			})
		</script>
			...
			<div class="container header">
				<div class="row">
					<div class="col-md-3 logo">
						<p class="lgo"><a href="index.php"><i class="fa fa-shopping-cart"></i> লোগো এখানে</a></p>
						<p class="fb">
					...
					<div class="col-md-9 header_right">
						<!--ul id="nav">
							<li><a href="">সকল বিজ্ঞাপন</a></li>
							<li><a href="">হেল্প ও সাপোর্ট</a></li>
							<li><a href=""> ফোন : ০১৮০ ০০০ ০০০০</a></li>
						</ul-->
						<div class="right_el">
							<p><a href="login.php" class="login"><i class="fa fa-user"></i> লগিন</a></p>
						</div>
					</div>
				</div>
			</div>
