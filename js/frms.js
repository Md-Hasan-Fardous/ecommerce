	...
	init:function(setting){
		...
		jQuery(function($){ //on document.ready
			...
			$sections.each(function(i){ //loop through $sections again
				...
				var $thestep=$('<div class="step disabledstep" />').data('section', i).html('<div class="smalltext"><span>'+(i+1)+'</span>'+$section.find('legend:eq(0)').text()+'</div>').appendTo($stepsguide)
			...
			var $paginatediv=$('<div class="formpaginate" style="font-family: verdana; overflow:hidden;"><span class="prev" style="float:left">Back</span> <span class="status">Step 1 of </span> <span class="next" style="float:right">Next</span></div>')
